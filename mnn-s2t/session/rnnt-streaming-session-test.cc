...
class TestRnntStreamingSessionWithBeamSearch : public ::testing::Test {
 protected:
  void SetUp() {
  ...
  void SetUpSessionCfg() {
    session_cfg_.decoding_cfg.beam_size = 4;
    session_cfg_.decoding_cfg.cutoff_top_k = 4;
    session_cfg_.decoding_cfg.max_token_step = 1;
    session_cfg_.decoding_cfg.decoding_type =
        decoding::DecodingType::kRnntBeamDecoding;
...
TEST_F(TestRnntStreamingSessionWithBeamSearch,
       TestRnntStreamingSessionCompleteProcess1) {
...
TEST_F(TestRnntStreamingSessionWithBeamSearch,
       TestRnntStreamingSessionCompleteProcess2) {
...
TEST_F(TestRnntStreamingSessionWithBeamSearch,
       TestRnntStreamingSessionCompleteProcess3) {
...
TEST_F(TestRnntStreamingSessionWithBeamSearch,
       TestRnntStreamingSessionCompleteProcess4) {
...
TEST_F(TestRnntStreamingSessionWithBeamSearch,
       TestRnntStreamingSessionCompleteProcess5) {
...
TEST_F(TestRnntStreamingSessionWithBeamSearch,
       TestRnntStreamingSessionCompleteProcess6) {
...
TEST_F(TestRnntStreamingSessionWithBeamSearch,
       TestRnntStreamingSessionCompleteProcess7) {
...
TEST_F(TestRnntStreamingSessionWithBeamSearch,
       TestRnntStreamingSessionCompleteProcess8) {
...
TEST_F(TestRnntStreamingSessionWithBeamSearch,
       TestRnntStreamingSessionCompleteProcess9) {
...
TEST_F(TestRnntStreamingSessionWithBeamSearch,
       TestRnntStreamingSessionCompleteProcess10) {
...
class TestRnntStreamingSessionWithGreedySearch : public ::testing::Test {
 protected:
  void SetUp() {
    this->SetUpRnntEncoderCfg();
    this->SetUpRnntPredictorCfg();
...
TEST_F(TestRnntStreamingSessionWithGreedySearch,
       TestRnntStreamingSessionCompleteProcess1) {
  std::string test_wav = "../sample_data/wavs/251-136532-0007.wav";
  wav_reader_->Open(test_wav);
  std::vector<float> pcm(wav_reader_->data(),
